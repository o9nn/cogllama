...
name: cogllamax
description: >
  Extended CogLlama documentation with detailed specifications for all OpenCog 
  components implemented as GGML/llama.cpp operations. This is the comprehensive 
  reference with detailed sub-component specifications in the cogllamax/ directory.
---
